...
#osu-cursor.active > .cursor-inner {
  ...
  var A = {
    ...
    obj: function (e) {
      return x(Object.prototype.toString.call(e), "Object");
    },
    pth: function (e) {
  ...
  var ze = (function () {
      ...
      function w(c, f, h, Q) {
        ...
        if (c !== f || h !== Q)
          for (var g = 0; g < e; ++g) m[g] = u(g * t, c, h);
        function D(y) {
  ...
  function ke(e) {
    if (A.rgb(e)) return Ge(e);
    if (A.hex(e)) return Re(e);
    if (A.hsl(e)) return Te(e);
  }
  function L(e) {
    var t =
  ...
  function je(e) {
    if (x(e, "translate") || e === "perspective") return "px";
    if (x(e, "rotate") || x(e, "skew")) return "deg";
  }
  function $(e, t) {
  ...
  function _(e, t, r) {
    var n = L(t);
    if (U([r, "deg", "rad", "turn"], n)) return t;
    var i = G.CSS[t + r];
    if (!A.und(i)) return i;
    var u = 100,
  ...
  function ee(e, t) {
    if (A.dom(e) && !A.inp(e) && (!A.nil(p(e, t)) || (A.svg(e) && e[t])))
      return "attribute";
    if (A.dom(e) && U(Se, t)) return "transform";
    if (A.dom(e) && t !== "transform" && de(e, t)) return "css";
  ...
  function Ue(e) {
    var t = e.points;
    return we(e) + ne(t.getItem(t.numberOfItems - 1), t.getItem(0));
  }
  function me(e) {
  ...
  function $e(e, t) {
    var r = A.str(e) ? ge(e)[0] : e,
      n = t || 100;
    return function (i) {
      return { property: i, el: r, svg: De(r), totalLength: me(r) * (n / 100) };
    };
  }
  function _e(e, t, r) {
    function n(c) {
  ...
  function Ie(e, t) {
    var r = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
      n = he(A.pth(e) ? e.totalLength : e, t) + "";
    return {
      original: n,
  ...
  function ie(e) {
    var t = e ? T(A.arr(e) ? e.map(ve) : ve(e)) : [];
    return R(t, function (r, n, i) {
  ...
  function ye(e) {
    ...
    return t.map(function (r, n) {
      return { target: r, id: n, total: t.length, transforms: { list: le(r) } };
    });
  }
  function et(e, t) {
    var r = K(t);
    if ((/^spring/.test(r.easing) && (r.duration = Ae(r.easing)), A.arr(e))) {
      var n = e.length,
        i = n === 2 && !A.obj(e[0]);
      i
        ? (e = { value: e })
        : A.fnc(t.duration) || (r.duration = t.duration / n);
    }
    var u = A.arr(e) ? e : [e];
    return u
      .map(function (a, o) {
        ...
        return (
          ...
          A.und(s.endDelay) &&
            (s.endDelay = o === u.length - 1 ? t.endDelay : 0),
          s
        );
      })
      .map(function (a) {
  ...
  function rt(e, t) {
    var r = [],
      n = t.keyframes;
    n && (t = k(tt(n), t));
    for (var i in t) A.key(i) && r.push({ name: i, tweens: et(t[i], e) });
    return r;
  }
  function nt(e, t) {
    var r = {};
    ...
    r.forEach(function (n) {
      for (var i in t) {
        var u = $(t[i], n),
          ...
          c = re(he(u, w), s),
          f = ee(a, i);
        Be[f](a, i, c, n.transforms, !0);
      }
    });
  }
  function st(e, t) {
    var r = ee(e.target, t.name);
    if (r) {
      var n = it(t, e),
        i = n[n.length - 1];
      return {
  ...
  var b = [],
    Ee = (function () {
      ...
      function t() {
        !e &&
          (!Ce() || !l.suspendWhenDocumentHidden) &&
          b.length > 0 &&
          (e = requestAnimationFrame(r));
      }
      function r(i) {
        for (var u = b.length, a = 0; a < u; ) {
          var o = b[a];
          o.paused ? (b.splice(a, 1), u--) : (o.tick(i), a++);
        }
  ...
  function l(e) {
    ...
    function w() {
      var d = s.direction;
      d !== "alternate" &&
        (s.direction = d !== "normal" ? "normal" : "reverse"),
      ...
      for (var v = 0, M = s.animations, H = M.length; v < H; ) {
        ...
        for (
          var P = C(d - B.start - B.delay, 0, B.duration) / B.duration,
            j = isNaN(P) ? 1 : B.easing(P),
            E = B.to.strings,
            se = B.round,
            ue = [],
            gt = B.to.numbers.length,
            N = void 0,
            S = 0;
          S < gt;
          S++
          ...
          var Z = void 0,
            He = B.to.numbers[S],
            Fe = B.from.numbers[S] || 0;
          B.isPath
            ? (Z = _e(B.value, j * He, B.isPathTargetInsideSVG))
            : (Z = Fe + j * (He - Fe)),
            se && ((B.isColor && S > 2) || (Z = Math.round(Z * se) / se)),
            ue.push(Z);
        }
        var Oe = E.length;
        if (!Oe) N = ue[0];
          ...
          for (var z = 0; z < Oe; z++) {
            ...
            var Pe = E[z + 1],
              ae = ue[z];
            isNaN(ae) || (Pe ? (N += ae + Pe) : (N += ae + " "));
          }
        }
        Be[I.type](F.target, I.property, N, F.transforms),
          (I.currentValue = N),
          v++;
      }
    }
    ...
    return (
      ...
      (s.play = function () {
        !s.paused ||
          (s.completed && s.reset(), (s.paused = !1), b.push(s), f(), Ee());
      }),
      (s.reverse = function () {
  ...
  function pe(e, t) {
    for (var r = t.length; r--; )
      U(e, t[r].animatable.target) && t.splice(r, 1);
  }
  function Le(e, t) {
    var r = t.animations,
      n = t.children;
    ...
    for (var i = n.length; i--; ) {
      var u = n[i],
        a = u.animations;
      pe(e, a), !a.length && !u.children.length && n.splice(i, 1);
    }
    !r.length && !n.length && t.pause();
  }
  function ot(e) {
    for (var t = ie(e), r = b.length; r--; ) {
      var n = b[r];
      Le(t, n);
    }
  }
    ...
    return function (y, d, v) {
      if ((o && (a = 0), s && (a = (v - 1) / 2), w && (a = v - 1), !g.length)) {
        ...
        n &&
          ...
          r === "reverse" &&
            (g = g.map(function (E) {
              return u ? (E < 0 ? E * -1 : -E) : Math.abs(D - E);
            }));
      }
      var j = c ? (h - f) / D : f;
      return m + j * (Math.round(g[d] * 100) / 100) + Q;
    };
  }
  function At(e) {
    e === void 0 && (e = {});
    ...
    return (
      ...
      (t.add = function (r, n) {
        ...
        (s.autoplay = !1),
          ...
          (s.timelineOffset = A.und(n) ? w : re(n, w)),
          a(t),
    ...
    init() {
      ...
      (t.textContent = Ye),
		...
		<div class='osu-cursor' id='osu-cursor'>
			...
			<img class='cursor-fg' src='${Ne}'/>
			<img class='cursor-additive' src='${xe}'/>
			</div>
		</div>`,
            document.body
          )),
          ...
          document.addEventListener("touchmove", this.touchFunc, {
            passive: !0,
          }),
