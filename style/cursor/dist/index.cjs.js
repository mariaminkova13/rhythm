...
function me(e, t) {
  var r = we(e),
    n = C(A.und(r[0]) ? 1 : r[0], 0.1, 100),
    i = C(A.und(r[1]) ? 100 : r[1], 0.1, 100),
    u = C(A.und(r[2]) ? 10 : r[2], 0.1, 100),
    a = C(A.und(r[3]) ? 0 : r[3], 0.1, 100),
    o = Math.sqrt(i / n),
    s = u / (2 * Math.sqrt(i * n)),
    w = s < 1 ? o * Math.sqrt(1 - s * s) : 0,
    c = 1,
    f = s < 1 ? (s * o + -a) / w : -a + o;
  function h(m) {
    var g = t ? (t * m) / 1e3 : m;
    return (
      s < 1
        ? (g =
            Math.exp(-g * s * o) * (c * Math.cos(w * g) + f * Math.sin(w * g)))
        : (g = (c + f * g) * Math.exp(-g * o)),
      m === 0 || m === 1 ? m : 1 - g
    );
  }
  function Q() {
    var m = R.springs[e];
    if (m) return m;
    for (var g = 1 / 6, D = 0, y = 0; ; )
      if (((D += g), h(D) === 1)) {
        if ((y++, y >= 16)) break;
      } else y = 0;
    var d = D * g * 1e3;
    return (R.springs[e] = d), d;
  }
  return t ? h : Q;
}
function ze(e) {
...
var Ge = (function () {
    ...
    function u(c, f, h) {
      return ((r(f, h) * c + n(f, h)) * c + i(f)) * c;
    }
    function a(c, f, h) {
      return 3 * r(f, h) * c * c + 2 * n(f, h) * c + i(f);
    }
    function o(c, f, h, Q, m) {
      var g,
        D,
        y = 0;
      do (D = f + (h - f) / 2), (g = u(D, Q, m) - c), g > 0 ? (h = D) : (f = D);
      while (Math.abs(g) > 1e-7 && ++y < 10);
      return D;
    }
    function s(c, f, h, Q) {
      for (var m = 0; m < 4; ++m) {
    ...
    function w(c, f, h, Q) {
      ...
      if (c !== f || h !== Q) for (var g = 0; g < e; ++g) m[g] = u(g * t, c, h);
      function D(y) {
        for (var d = 0, v = 1, M = e - 1; v !== M && m[v] <= y; ++v) d += t;
        --v;
        var H = (y - m[v]) / (m[v + 1] - m[v]),
          I = d + H * t,
          F = a(I, c, h);
        return F >= 0.001 ? s(y, I, c, h) : F === 0 ? I : o(y, d, d + t, c, h);
      }
      return function (y) {
        return (c === f && h === Q) || y === 0 || y === 1 ? y : u(D(y), f, Q);
      };
    }
    return w;
  })(),
  De = (function () {
    ...
    return (
      ...
      Object.keys(t).forEach(function (n) {
        var i = t[n];
        (e["easeIn" + n] = i),
          (e["easeOut" + n] = function (u, a) {
            return function (o) {
              return 1 - i(u, a)(1 - o);
            };
          }),
          (e["easeInOut" + n] = function (u, a) {
            return function (o) {
              return o < 0.5 ? i(u, a)(o * 2) / 2 : 1 - i(u, a)(o * -2 + 2) / 2;
            };
          }),
          (e["easeOutIn" + n] = function (u, a) {
            return function (o) {
              return o < 0.5
                ? (1 - i(u, a)(1 - o * 2)) / 2
                : (i(u, a)(o * 2 - 1) + 1) / 2;
...
function T(e, t) {
  for (
    ...
    if (u in e) {
      var a = e[u];
      t.call(n, a, u, e) && i.push(a);
    }
  return i;
}
function k(e) {
  return e.reduce(function (t, r) {
    return t.concat(A.arr(r) ? k(r) : r);
  }, []);
}
function fe(e) {
  return A.arr(e)
...
function j(e, t) {
  var r = ee(e);
  for (var n in t) r[n] = A.und(e[n]) ? t[n] : e[n];
  return r;
}
function Re(e) {
...
function Te(e) {
  var t = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    r = e.replace(t, function (o, s, w, c) {
      return s + s + w + w + c + c;
    }),
...
function ke(e) {
  ...
  if (n == 0) o = s = w = i;
    ...
    var c = i < 0.5 ? i * (1 + n) : i + n - i * n,
      f = 2 * i - c;
    (o = a(f, c, r + 1 / 3)), (s = a(f, c, r)), (w = a(f, c, r - 1 / 3));
  }
  return "rgba(" + o * 255 + "," + s * 255 + "," + w * 255 + "," + u + ")";
}
function je(e) {
  if (A.rgb(e)) return Re(e);
  if (A.hex(e)) return Te(e);
  if (A.hsl(e)) return ke(e);
}
function L(e) {
  var t =
...
function Xe(e) {
  if (z(e, "translate") || e === "perspective") return "px";
  if (z(e, "rotate") || z(e, "skew")) return "deg";
}
function K(e, t) {
...
function te(e, t, r) {
  var n = L(t);
  if (_([r, "deg", "rad", "turn"], n)) return t;
  var i = R.CSS[t + r];
  if (!A.und(i)) return i;
  var u = 100,
  ...
  o.appendChild(a), (a.style.position = "absolute"), (a.style.width = u + r);
  var s = u / a.offsetWidth;
  o.removeChild(a);
  var w = s * parseFloat(t);
  return (R.CSS[t + r] = w), w;
}
function ye(e, t, r) {
  if (t in e.style) {
...
function re(e, t) {
  if (A.dom(e) && !A.inp(e) && (!A.nil(p(e, t)) || (A.svg(e) && e[t])))
    return "attribute";
  if (A.dom(e) && _(Ze, t)) return "transform";
  if (A.dom(e) && t !== "transform" && ye(e, t)) return "css";
...
function We(e, t, r, n) {
  var i = z(t, "scale") ? 1 : 0 + Xe(t),
    u = Be(e).get(t) || i;
  return (
    r && (r.transforms.list.set(t, u), (r.transforms.last = t)),
    n ? te(e, u, n) : u
  );
}
function ne(e, t, r, n) {
...
function Ue(e) {
  return se({ x: p(e, "x1"), y: p(e, "y1") }, { x: p(e, "x2"), y: p(e, "y2") });
}
function Me(e) {
  for (var t = e.points, r = 0, n, i = 0; i < t.numberOfItems; i++) {
    var u = t.getItem(i);
    i > 0 && (r += se(n, u)), (n = u);
  }
  return r;
...
function Ke(e) {
  var t = e.points;
  return Me(e) + se(t.getItem(t.numberOfItems - 1), t.getItem(0));
}
function be(e) {
...
function $e(e) {
  for (var t = e.parentNode; A.svg(t) && A.svg(t.parentNode); )
    t = t.parentNode;
  return t;
}
function Ee(e, t) {
...
function _e(e, t) {
  var r = A.str(e) ? Ie(e)[0] : e,
    n = t || 100;
  return function (i) {
    return { property: i, el: r, svg: Ee(r), totalLength: be(r) * (n / 100) };
  };
}
function et(e, t, r) {
  function n(c) {
...
function ge(e, t) {
  var r = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
    n = Qe(A.pth(e) ? e.totalLength : e, t) + "";
  return {
    original: n,
    numbers: n.match(r) ? n.match(r).map(Number) : [0],
    strings: A.str(e) || t ? n.split(r) : [],
  };
}
function ue(e) {
  var t = e ? k(A.arr(e) ? e.map(fe) : fe(e)) : [];
...
function Ce(e) {
  ...
  return t.map(function (r, n) {
    return { target: r, id: n, total: t.length, transforms: { list: Be(r) } };
  });
}
function tt(e, t) {
  var r = ee(t);
  if ((/^spring/.test(r.easing) && (r.duration = me(r.easing)), A.arr(e))) {
    var n = e.length,
      i = n === 2 && !A.obj(e[0]);
    i ? (e = { value: e }) : A.fnc(t.duration) || (r.duration = t.duration / n);
  }
  var u = A.arr(e) ? e : [e];
  return u
    .map(function (a, o) {
      var s = A.obj(a) && !A.pth(a) ? a : { value: a };
      return (
        A.und(s.delay) && (s.delay = o ? 0 : t.delay),
        A.und(s.endDelay) && (s.endDelay = o === u.length - 1 ? t.endDelay : 0),
        s
      );
    })
    .map(function (a) {
...
function rt(e) {
  for (
    var t = T(
        ...
        return u.indexOf(a) < 0 && u.push(a), u;
      }, []),
      r = {},
      n = function (u) {
        var a = t[u];
        r[a] = e.map(function (o) {
          var s = {};
          for (var w in o)
            A.key(w) ? w == a && (s.value = o[w]) : (s[w] = o[w]);
          return s;
        });
      },
      i = 0;
...
function nt(e, t) {
  var r = [],
    n = t.keyframes;
  n && (t = j(rt(n), t));
  for (var i in t) A.key(i) && r.push({ name: i, tweens: tt(t[i], e) });
  return r;
}
function it(e, t) {
  var r = {};
...
function st(e, t) {
  ...
  return e.tweens.map(function (n) {
    ...
    return (
      ...
      (i.easing = $(i.easing, i.duration)),
      (i.isPath = A.pth(u)),
      (i.isPathTargetInsideSVG = i.isPath && A.svg(t.target)),
  ...
  r.forEach(function (n) {
    for (var i in t) {
      var u = K(t[i], n),
        ...
        c = ie(Qe(u, w), s),
        f = re(a, i);
      pe[f](a, i, c, n.transforms, !0);
    }
  });
}
function ut(e, t) {
  var r = re(e.target, t.name);
  if (r) {
    var n = st(t, e),
      i = n[n.length - 1];
    return {
...
var E = [],
  Fe = (function () {
    ...
    function t() {
      !e &&
        (!de() || !l.suspendWhenDocumentHidden) &&
        E.length > 0 &&
        (e = requestAnimationFrame(r));
    }
    function r(i) {
      for (var u = E.length, a = 0; a < u; ) {
        var o = E[a];
        o.paused ? (E.splice(a, 1), u--) : (o.tick(i), a++);
      }
...
function l(e) {
  ...
  function o(d) {
    ...
    return (d.finished = v), v;
  }
  var s = ot(e);
  o(s);
  function w() {
    var d = s.direction;
    d !== "alternate" && (s.direction = d !== "normal" ? "normal" : "reverse"),
      (s.reversed = !s.reversed),
      i.forEach(function (v) {
        return (v.reversed = s.reversed);
      });
  }
  function c(d) {
    return s.reversed ? s.duration - d : d;
  }
  function f() {
    (t = 0), (r = c(s.currentTime) * (1 / l.speed));
  }
  function h(d, v) {
    v && v.seek(d - v.timelineOffset);
  }
  function Q(d) {
    if (s.reversePlayback) for (var M = u; M--; ) h(d, i[M]);
    else for (var v = 0; v < u; v++) h(d, i[v]);
  }
  function m(d) {
    for (var v = 0, M = s.animations, H = M.length; v < H; ) {
      var I = M[v],
        F = I.animatable,
        x = I.tweens,
        O = x.length - 1,
      ...
      for (
        var P = C(d - B.start - B.delay, 0, B.duration) / B.duration,
          G = isNaN(P) ? 1 : B.easing(P),
          b = B.to.strings,
          X = B.round,
          W = [],
          Pe = B.to.numbers.length,
          N = void 0,
          Y = 0;
        Y < Pe;
        Y++
        ...
        var S = void 0,
          ae = B.to.numbers[Y],
          oe = B.from.numbers[Y] || 0;
        B.isPath
          ? (S = et(B.value, G * ae, B.isPathTargetInsideSVG))
          : (S = oe + G * (ae - oe)),
          X && ((B.isColor && Y > 2) || (S = Math.round(S * X) / X)),
          W.push(S);
      }
      var ce = b.length;
      if (!ce) N = W[0];
        ...
        for (var Z = 0; Z < ce; Z++) {
          ...
          var Ae = b[Z + 1],
            V = W[Z];
          isNaN(V) || (Ae ? (N += V + Ae) : (N += V + " "));
        }
      }
      pe[I.type](F.target, I.property, N, F.transforms),
        (I.currentValue = N),
        v++;
    }
  }
  function g(d) {
    s[d] && !s.passThrough && s[d](s);
  }
  function D() {
  ...
  function y(d) {
    var v = s.duration,
      ...
      H = v - s.endDelay,
      I = c(d);
    (s.progress = C((I / v) * 100, 0, 100)),
      (s.reversePlayback = I < s.currentTime),
      i && Q(I),
      !s.began && s.currentTime > 0 && ((s.began = !0), g("begin")),
      !s.loopBegan && s.currentTime > 0 && ((s.loopBegan = !0), g("loopBegin")),
      I <= M && s.currentTime !== 0 && m(0),
      ((I >= H && s.currentTime !== v) || !v) && m(v),
      I > M && I < H
        ? (s.changeBegan ||
            ((s.changeBegan = !0), (s.changeCompleted = !1), g("changeBegin")),
          g("change"),
          m(I))
        : s.changeBegan &&
          ((s.changeCompleted = !0), (s.changeBegan = !1), g("changeComplete")),
      (s.currentTime = C(I, 0, v)),
      s.began && g("update"),
      d >= v &&
        ((r = 0),
        D(),
        s.remaining
          ? ((t = n),
            g("loopComplete"),
            (s.loopBegan = !1),
            s.direction === "alternate" && w())
          : ((s.paused = !0),
            s.completed ||
              ((s.completed = !0),
              g("loopComplete"),
              g("complete"),
              !s.passThrough && "Promise" in window && (a(), o(s)))));
  }
  return (
    (s.reset = function () {
      var d = s.direction;
      (s.passThrough = !1),
        ...
        (i = s.children),
        (u = i.length);
      for (var v = u; v--; ) s.children[v].reset();
      ((s.reversed && s.loop !== !0) || (d === "alternate" && s.loop === 1)) &&
        s.remaining++,
    ...
    (s.play = function () {
      !s.paused ||
        (s.completed && s.reset(), (s.paused = !1), E.push(s), f(), Fe());
    }),
    (s.reverse = function () {
      w(), (s.completed = !s.reversed), f();
    }),
    (s.restart = function () {
      s.reset(), s.play();
    }),
...
function le(e, t) {
  for (var r = t.length; r--; ) _(e, t[r].animatable.target) && t.splice(r, 1);
}
function Oe(e, t) {
  var r = t.animations,
    n = t.children;
  ...
  for (var i = n.length; i--; ) {
    var u = n[i],
      a = u.animations;
    le(e, a), !a.length && !u.children.length && n.splice(i, 1);
  }
  !r.length && !n.length && t.pause();
}
function ct(e) {
  for (var t = ue(e), r = E.length; r--; ) {
    var n = E[r];
    Oe(t, n);
  }
}
function At(e, t) {
  ...
  return function (y, d, v) {
    if ((o && (a = 0), s && (a = (v - 1) / 2), w && (a = v - 1), !g.length)) {
      for (var M = 0; M < v; M++) {
        if (!i) g.push(Math.abs(a - M));
        else {
          var H = s ? (i[0] - 1) / 2 : a % i[0],
      ...
      n &&
        ...
        r === "reverse" &&
          (g = g.map(function (b) {
            return u ? (b < 0 ? b * -1 : -b) : Math.abs(D - b);
          }));
    }
    var G = c ? (h - f) / D : f;
    return m + G * (Math.round(g[d] * 100) / 100) + Q;
  };
}
function ft(e) {
  e === void 0 && (e = {});
  ...
  return (
    ...
    (t.add = function (r, n) {
      ...
      for (var o = 0; o < u.length; o++) a(u[o]);
      var s = j(r, U(q, e));
      s.targets = s.targets || e.targets;
      var w = t.duration;
      (s.autoplay = !1),
        (s.direction = t.direction),
        (s.timelineOffset = A.und(n) ? w : ie(n, w)),
        a(t),
...
class gt {
  constructor(t) {
    var r, n;
    (this.options = t || {}),
      (n = (r = this.options).rotate) != null || (r.rotate = !0),
      this.init();
  }
  injectHtml(t, r) {
    let n = document.createElement("div");
    for (n.innerHTML = t; n.children.length > 0; ) r.appendChild(n.children[0]);
    return r.lastChild;
  }
  init() {
    (this.dragState = 0),
      ...
      (this.rotateState = { isInAnimation: !1, degrees: 0 }),
      (this.isTouch = !1);
    const t = document.createElement("style");
    (t.textContent = Se),
      document.body.appendChild(t),
      !document.querySelector("#osu-cursor") &&
        ((this.cursor = this.injectHtml(
          `
		<div class='osu-cursor' id='osu-cursor'>
			<div class='cursor-inner'>
			<img class='cursor-fg' src='${xe}'/>
			<img class='cursor-additive' src='${Ye}'/>
			</div>
		</div>`,
          document.body
        )),
        ...
        document.addEventListener("touchstart", this.touchFunc, {
          passive: !0,
        }),
        document.addEventListener("touchmove", this.touchFunc, { passive: !0 }),
        document.addEventListener("mouseup", this.mouseUpFunc, { passive: !0 }),
        document.addEventListener("mouseleave", this.mouseLeaveFunc, {
          passive: !0,
        }),
        document.addEventListener("drag", this.dragFunc, { passive: !0 }),
        document.addEventListener("dragend", this.dragEndFunc, {
          passive: !0,
        }));
  }
  getCurrentCursorStyle(t) {
    return t.hasAttribute("orig-cursor")
      ? t.getAttribute("orig-cursor")
  ...
  mouseMove(t) {
    ...
    if (
      ((this.cursor.style.top = t.pageY - window.pageYOffset + "px"),
      (this.cursor.style.left = t.pageX - window.pageXOffset + "px"),
      (this.dragState == 1 || this.dragState == 2) && this.options.rotate)
    ) {
      const r = t.pageX - window.pageXOffset - this.dragStartPos.x,
        n = t.pageY - window.pageYOffset - this.dragStartPos.y;
      if (r * r + n * n > 30 * 30) this.dragState = 2;
      else return;
      const u =
        ((Math.atan2(-r, n) * 180) / Math.PI +
          24.3 -
          this.rotateState.degrees) %
        360;
      u < -180 && (u += 360),
        u > 180 && (u -= 360),
        (this.rotateState.degrees += u),
        l.remove(this.cursor),
  ...
  mouseDown(t) {
    ...
    this.visible &&
      ((this.dragStartPos.x = t.pageX - window.pageXOffset),
      (this.dragStartPos.y = t.pageY - window.pageYOffset),
      (this.rotateState.degrees = 0),
      this.cursor.classList.add("active"),
      l.remove(this.cursorInner),
      l({
  ...
  mouseUp(t) {
    this.visible &&
      (this.dragState == 2 &&
        (l.remove(this.cursor),
        (this.rotateState.isInAnimation = !0),
        ...
        l({
          ...
          easing: function () {
            return function (r) {
              return (
                Math.pow(2, -10 * r) *
                  Math.sin((0.5 * r - 0.075) * 20.943951023931955) +
                1 -
                0.0004882812499999998 * r
              );
            };
          },
          complete: () => {
            (this.rotateState.isInAnimation = !1), new Event("click");
          },
        }),
        (this.rotateState.degrees = 0)),
      (this.dragState = 0),
      ...
      l({
        ...
        easing: function () {
          return function (r) {
            return (
              Math.pow(2, -10 * r) *
                Math.sin((r - 0.075) * 20.943951023931955) +
              1 -
              0.00048828125 * r
            );
          };
  ...
  mouseOver(t) {
    ...
    const r = this.getCurrentCursorStyle(t.target);
    ["default", "auto", "none"].includes(r)
      ? ((this.visible = !0),
        (document.documentElement.style.cursor = "none"),
        t.target.style.removeProperty("cursor"),
      ...
      ? ((this.visible = !0),
        (document.documentElement.style.cursor = "none"),
        t.target.setAttribute("orig-cursor", r),
        (t.target.style.cursor = "none"),
        (this.cursor.style.display = "block"),
        this.dragState == 0 &&
          !this.rotateState.isInAnimation &&
          ((this.dragState = 3),
          l.remove(this.cursor),
          (this.cursor.style.transition = "transform 0.15s"),
  ...
  stop() {
    document.removeEventListener("mousemove", this.mouseMoveFunc),
      ...
      this.cursor && (this.cursor.remove(), (this.cursor = null));
  }
}
window.osuCursor = gt;
